...
namespace InventorySystem.Api
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<InventoryDbContext>(options => options.UseSqlServer(Configuration.GetConnectionString("Default"), x => x.MigrationsAssembly("InventorySystem.Data")));
